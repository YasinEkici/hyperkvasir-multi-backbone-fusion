...
\begin{table}[H]
  ...
  \begin{tabular}{llcccc}
    ...
    Yapılandırma & Füzyon & Doğruluk (ort$\pm$std) & Makro-F1 (ort$\pm$std)
      & Makro-F1 havuz [\%95 GA] \\
    \midrule
    \textbf{V+S+B} & \textbf{weighted} & $0{,}8780\pm0{,}0140$
      & $\mathbf{0{,}6094\pm0{,}0254}$ & $\mathbf{0{,}6119\;[0{,}5930,\,0{,}6295]}$ \\
...
\begin{table}[H]
  ...
  \begin{tabular}{lcc}
    ...
    \midrule
    Temel (nihai model)        & $0{,}6119$ & headline \\
    Seed topluluğu             & $0{,}6157$ & GA örtüşür (anlamsız) \\
    TTA                        & $-$ & GA düzeyinde kazanım yok \\
